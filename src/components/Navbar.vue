<template>
  ...
  >
    <div class="flex items-center justify-between h-[76px] max-w-[1394px] mx-auto">
      ...
      <!-- Desktop Menu -->
      <div
        class="hidden md:flex flex-1 justify-center items-center gap-[46px] font-times text-[24px] text-black"
      >
    ...
    <div 
      ...
      class="md:hidden absolute top-full left-0 w-full bg-cream shadow-lg border-t border-primary/10 py-4 px-6 flex flex-col gap-4"
    >
      <RouterLink 
        to="/" 
